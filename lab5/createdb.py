...
con = psycopg2.connect(database="students", user="postgres",
                       password="30302000", host="127.0.0.1", port="5432")
...
for i in range(100):
    print(i)
    cur.execute("INSERT INTO STUDENT (Admission,Name,Age,Course,Department) VALUES ('"+ str(i)+"','"+fake.name()+"','"+str(fake.pyint(16, 50, 1))+"','Computer Science', 'ICT')")
    con.commit()
